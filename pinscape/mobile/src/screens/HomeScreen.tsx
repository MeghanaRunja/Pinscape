...
// Typed as CategoryKey[] so TypeScript catches any key not in the union.
const KEYS: CategoryKey[] = ['bedroom', 'nails', 'outfit', 'hair', 'makeup', 'living'];
      ...
      <ScrollView contentContainerStyle={s.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={s.hero}>
          ...
          <Text style={s.heroSub}>
            Connect your Pinterest boards, upload your space or yourself,
            pick your pins — see them applied to real life.
          </Text>
        </View>
        <View style={s.grid}>
          {KEYS.map(key => {
            ...
            return (
              <TouchableOpacity
                ...
                style={s.card}
                activeOpacity={0.75}
                onPress={() => nav.navigate('Upload', { categoryKey: key })}
              >
